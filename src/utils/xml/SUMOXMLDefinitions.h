...
enum SumoXMLTag {
    ...
    GNE_TAG_PERSONTRIP_FIRST_EDGE,
    GNE_TAG_PERSONTRIP_FIRST_BUSSTOP,
    // walks
    GNE_TAG_WALK_EDGE,
    GNE_TAG_WALK_BUSSTOP,
    GNE_TAG_WALK_FIRST_EDGE,
    GNE_TAG_WALK_FIRST_BUSSTOP,
    GNE_TAG_WALK_EDGES,
    GNE_TAG_WALK_ROUTE,
    // rides
    GNE_TAG_RIDE_EDGE,
    GNE_TAG_RIDE_BUSSTOP,
    GNE_TAG_RIDE_FIRST_EDGE,
    GNE_TAG_RIDE_FIRST_BUSSTOP,
    // person stops
